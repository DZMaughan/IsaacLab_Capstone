...
from isaaclab.sensors import ContactSensor, RayCaster, ContactSensorCfg, RayCasterCfg, patterns
...
class BD1WalkingFixedEnv(DirectRLEnv):
    cfg: BD1WalkingFixedEnvCfg

    def __init__(self, cfg: BD1WalkingFixedEnvCfg, render_mode: str | None = None, **kwargs):
